...
func init() {
	...
	docsCmd.Flags().StringVar(&flagTarget, "target", "claude", "target platforms: comma list of claude|cl, codex|co, kilo|ki, opencode|op, or all. codex/opencode/kilo are opt-in")
